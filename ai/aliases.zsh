alias a='vibe --max-price 0.05 '
alias viber='vibe -c --max-price 0.05 --trust --agent auto-approve'
alias agr='source .ai/.env; agr-agent-rebuild'
alias vip='vibe --max-price 0.05 --trust --agent auto-approve -p'
alias vipc='vibe -c -p'
alias vigo='vibe --max-price 0.05 --trust --agent auto-approve -p go'
alias vifb='vibe --max-price 0.05 --trust --agent auto-approve -p fb'
